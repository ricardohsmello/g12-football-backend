...
public class LiveMatchScoreDocument {
    ...
    public LiveMatchScoreDocument(String id, String matchId, String competitionId, Score score, Date updatedAt) {
        this.id = id;
    ...
    public LiveMatchScore toModel() {
        return new LiveMatchScore(id, matchId.toString(), competitionId, score, updatedAt);
    }
